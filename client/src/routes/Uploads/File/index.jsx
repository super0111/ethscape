...
const File = ({ history, match }) => {
  const { user, token, setPostType, setFabVisible, setWalletConnectVisible, setForumMenuActive, setModalOpen, lang } = useContext(StoreContext)
  ...
  useEffect(() => {
    ...
    document.title = 'EthScape | ' + fileTitle
  }, [file, lang])
