...
router.get('/getProducts1', GeneralController.getProducts1)
router.post('/addToCart', GeneralController.addToCart)
router.post('/addToCart1', GeneralController.addToCart1)
router.get('/getCartLists', GeneralController.getCartLists)
router.delete('/emptyCartList', GeneralController.emptyCartList)
router.delete('/emptyCartList1', GeneralController.emptyCartList1)
router.post('/checkoutPayment', GeneralController.checkoutPayment)
...
router.get('/event/recent', GeneralController.getRecentEventBanner)
router.post('/event/create', verifyAccessToken, GeneralController.createEventBanner)
router.get('/promo/recent', GeneralController.getRecentPromotion)
router.post('/promo/create', verifyAccessToken, GeneralController.createPromotion)
...
router.put('/profile/wallet/connect', verifyAccessToken, ProfileController.setupWallet)
...
/*
  File Uploading is disabled for now, until there is a clear need for it.
  As for now I think we can allow sharing of images on the threads, answers, and avatars
  and allow community moderation of content being appropriate, and banning bad behavior.
