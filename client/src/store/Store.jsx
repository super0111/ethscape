...
const Store = ({ children }) => {
  ...
  const setWalletConnectVisible = (payload) => {
    dispatch({
      type: 'SET_WALLET_CONNECT_VISIBLE',
      payload
    })
  }

  const setUserWallet = (payload) => {
    dispatch({
  ...
  const setForumMenuActive = (payload) => {
    dispatch({
      type: 'SET_FORUM_MENU_ACTIVE',
      payload
    })
  }
  ...
  const store = {
    ...
    logout,
    setUserWallet,
    forumMenuActive: state.forumMenuActive,
    setForumMenuActive,
  }
