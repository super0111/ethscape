...
const Users = ({ history, location: { pathname } }) => {
  const { user, setPostType, setFabVisible, setWalletConnectVisible, setForumMenuActive, lang } = useContext(StoreContext)
  document.title = 'EthScape | ' + Strings.users[lang]
