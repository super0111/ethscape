...
const ForumMenu = ({ open, setMenuOpen }) => {
        ...
        <ul className="nav_links">
          ...
          <li className="nav_item">
            <NavLink to="/forum" onClick={() => setMenuOpen(false)}>
              <span className="nav_text">{Strings.forum[lang]}</span>
            </NavLink>
          </li>
          {user && (
            <>
          ...
          {/* <li className="nav_item">
            <NavLink to="/store" onClick={() => setMenuOpen(false)}>
              <span className="nav_text">{Strings.store[lang]}</span>
            </NavLink>
          </li>
          <li className="nav_item">
            <NavLink to="/nfts" onClick={() => setMenuOpen(false)}>
              <span className="nav_text">{Strings.nfts[lang]}</span>
            </NavLink>
          </li>
          <li className="nav_item">
            <NavLink to="/merch" onClick={() => setMenuOpen(false)}>
              <span className="nav_text">{Strings.merchandise[lang]}</span>
            </NavLink>
          </li> */}
