      ...
      <CustomScrollbar className="navigation__menu">
        ...
        >
          <div className="menu">
            ...
            {/* Disabling language features until there is a need to translate site into
                  specific languages besides english.
              <DropdownItem
              leftIcon="world"
            ...
            {/* Remove the ability to update theming and focus on one EthScape.io based theme
            <DropdownItem
              leftIcon="palette"
              onClick={changeTheme}
            >
